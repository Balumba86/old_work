...
@section('title-page')Категории сервисов/услуг@endsection
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Категории сервисов/услуг</h3>
        </div>
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tr>
                            ...
                            <th><a href="{{route('admin-service-category-add')}}" class="btn btn-outline-success btn-sm"><i class="fas fa-plus"></i></a></th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin-service-category-edit', $category->id)}}" class="btn btn-outline-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                ...
                                <form onsubmit="true" action="{{route('admin-service-category-delete', $category->id)}}" method="post" id="drop-form-{{$category->id}}">
                                    @method('DELETE')
                                    @csrf
